...
return {
    ...
    quest_defs = {
        ...
        {
            name = "too-many-belts",
            conditions = {{type = "trades-found", progress_requirement = 1500}},
            ...
            rewards = {
                {type = "all-trades-productivity", value = 1},
                {
                    ...
                    value = {
                        ...
                        {name = "personal-roboport-mk2-equipment", count = 3, quality = "uncommon"},
                        {name = "energy-shield-mk2-equipment", count = 4, quality = "uncommon"},
                        {name = "exoskeleton-equipment", count = 3, quality = "uncommon"},
                        {name = "battery-mk3-equipment", count = 2, quality = "uncommon"},
                        {name = "fission-reactor-equipment", count = 1, quality = "uncommon"},
                    },
